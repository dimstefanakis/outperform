      ...
      >
        {data.cta_icon && (
          <ImageBox
            ...
            alt={'CTA Icon'}
            classesWrapper="w-3 h-3 5xl:w-5 5xl:h-5 mr-2 mb-1 rounded-none"
            imageClasses="w-full h-full"
          />
        )}
        <span className="5xl:text-[1.5rem]">{data.cta_text}</span>
      </button>
      {data.outro_description && (
        <div className='w-full flex flex-col items-center justify-center'>
          <div className="w-full mt-6 text-[#686868] max-w-[500px] 5xl:max-w-[700px] flex justify-end px-4 lg:px-10">
            <div className="text-md md:text-xs 5xl:text-[1.5rem] 5xl:leading-[1.6rem] text-center">
