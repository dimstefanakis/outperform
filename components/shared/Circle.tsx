...
export function Circle({ data }: { data: CircleInterface }) {
  return (
    <div className="flex flex-col items-center">
      <div className="w-[300px] h-[300px] 5xl:w-[350px] 5xl:h-[350px] bg-black rounded-full flex flex-col items-center justify-center text-white p-5">
        ...
        <p className="text-md 5xl:text-[1.5rem] 5xl:leading-6 text-center p-4">{data.description}</p>
      </div>
